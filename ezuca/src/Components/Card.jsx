...
const Card = (props) => {
    ...
    return (
        <div>
            <div className='bg-white  w-[315px] h-[330px] flex items-start flex-col gap-4 border-r border-b border-[#c0bfbf8c] responsive-card'>
...
export const Card2 = (props) => {
    ...
    return (
        <div>
            <div className='flex items-center  flex-row border border-[grey] w-[500px] res-card2'>
