        ...
        <div>
            <div className="image">
                <div className='img-text'>
                    ...
                    <p className='text-white text-base mt-9 desc' >Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Sed ut perspiciatis unde omnis iste natus error <br /> sit voluptatem accusantium doloremque laudantium</p>
                ...
                <div className='flex justify-center gap-[616px] mt-10 featured'>
                ...
                <div className='flex gap-4 mt-10 flex-wrap res-card'>
