  ...
  return (
    <div>
      <div className='flex flex-row items-center justify-around flex-wrap'>
        ...
        <div className='mt-5' >
          <div className='border rounded-full bg-[#19c880] w-[60px] h-[60px] absolute top-[350px] right-[620px] video'><img src="https://themewagon.github.io/ezuca/images/video-icon.png" alt="" /></div>
