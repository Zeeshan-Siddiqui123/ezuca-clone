...
const Blog = () => {
  return (
    <div>
      ...
      <div className="flex gap-1 w-full flex-row mt-32 flex-wrap items-center justify-center">
        ...
        <div className='flex flex-col gap-1 flex-wrap justify-center'>
          <div className='flex flew-row gap-1 flex-wrap justify-center'>
          ...
          <div className='flex flex-row gap-1 flex-wrap justify-center'>
            ...
            <div className='flex flex-col gap-1 img-flex'>
      ...
      <div className='flex gap-2 items-center justify-center ml-[535px] set-image'>
        <img src="https://themewagon.github.io/ezuca/images/n.jpg" alt="" />
      </div>
      <Footer/>
    </div>
